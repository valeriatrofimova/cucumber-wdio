...
describe('reporter', () => {
    ...
    const logFolderPath = path_1.default.join(__dirname, '../../', logFolder);
    ...
    describe('on create', () => {
        it('should set the defaults if only the logfile option is provided', () => {
            const noOptionsReporter = new reporter_1.default({ logFile: path_1.default.join(logFolder, logFileName) });
    ...
    describe('onRunnerEnd', () => {
        it('should store the json file on the file system', () => {
            ...
            expect((0, fileExists_1.fileExists)(jsonFolder)).toEqual(false);
    ...
    describe('getFeatureDataObject', () => {
        ...
        it('should be able to to create a feature JSON data object with no line data', () => {
            expect(tmpReporter.getFeatureDataObject(mocks_1.SUITE_FEATURE_UID)).toMatchSnapshot();
        });
    });
    describe('getScenarioDataObject', () => {
        it('should be able to to create a scenario JSON data object', () => {
            expect(tmpReporter.getScenarioDataObject(mocks_1.TEST_SCENARIO_STATS, 'create-passed-feature')).toMatchSnapshot();
        });
    });
    describe('getStepDataObject', () => {
        ...
        it('should be able to to create a step JSON data object based on missing keyword data', () => {
            expect(tmpReporter.getStepDataObject(mocks_1.TEST_NO_KEYWORD_STATS)).toMatchSnapshot();
            expect(getFailedMessageSpy).toHaveBeenCalled();
        });
    });
